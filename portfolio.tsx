            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground text-base leading-relaxed">
                  UXを重視するフロントエンド開発者です。ゲームからWebアプリケーション、モバイルアプリまで、さまざまなプロジェクトを手掛け、新しい技術に挑戦しています。直感的に操作できるインターフェースを提供することに情熱を注ぎ、デザインと機能性の両立を常に目指しています。また、フロントエンドだけでなく、バックエンドの経験も積みながら、将来的にはフルスタック開発者として成長していくことを目指しています。
                </p>
              </div>
